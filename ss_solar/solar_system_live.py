...
"""computes planets position by using orbital elements, increases day count and updates data"""
...
origin_day = (datetime.date(1999, 12, 31))


"""to change speed"""
time_pass = 5 #days/delay
delay = 0.5
#every delay(seconds), adds time_pass(days)

class day(threading.Thread):
    def run(self):
        ...
        while True:
            ...
            d+= time_pass
            day.d = d
            tdelta = datetime.timedelta(days=d)
            day.date_count = origin_day + tdelta
            #---class
            class Planet:
            ...
            day.Mercury_long = Mercury.long
            day.Venus_long = Venus.long
            day.Earth_RA = Earth.RA
            day.Mars_long = Mars.long
            day.Jupiter_long = Jupiter.long
            day.Saturn_long = Saturn.long
            day.Uranus_long = Uranus.long
            day.Neptune_long = Neptune.long

            tcheck_2 = time.time()
            time.sleep(delay-(tcheck_2-tcheck_1))
